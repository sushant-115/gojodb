...
// 	"github.com/hashicorp/raft-boltdb" // BoltDB backend for Raft log and stable store

// 	"gojodb/controller/fsm" // Our custom FSM
// )
...
// 	config.Logger = log.New(os.Stderr, fmt.Sprintf("[%s RAFT] ", c.nodeID), log.LstdFlags) // Raft-specific logger
...
// 	controller, err := NewController(nodeID, raftBindAddr, httpAddr, raftDataPath, joinAddr, heartbeatListenPort) // Pass heartbeatListenPort
// 	if err != nil {
