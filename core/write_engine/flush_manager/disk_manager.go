...
// 	Version        uint32
// 	PageSize       uint32
// 	RootPageID     btree.PageID // uint64
// 	Degree         uint32
// 	TreeSize       uint64                               // Persisted tree size
// 	FreeListPageID btree.PageID                               // uint64
// 	LastLSN        btree.LSN                                  // uint64
// 	_              [btree.DbFileHeaderSize - (4*4 + 4*8)]byte // Explicit padding: Corrected calculation
// }
...
// 	if len(filePath) > btree.MaxFilenameLength {
...
// 		// File does not exist
// 		if !create {
// 			return nil, fmt.Errorf("%w: %s", btree.ErrDBFileNotFound, dm.filePath)
// 		}
